...
const About = () => {
  return (
    <section
      id="about"
      className="py-1 px-[7vw] md:px-[7vw] lg:px-[20vw] font-sans mt-16 md:mt-24 lg:mt-32"
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1pnKgU4PUqJIKa1UeGXgIfuqz_h7nso88/view?usp=sharing"
            target="_blank"
